...
<div class="reveal" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 24px; flex-wrap: wrap; gap: 12px;">
    <div>
        <h1 style="font-size: 26px; font-weight: 800; color: var(--ink); margin: 0; letter-spacing: -0.5px;">Inventaris <span style="color: var(--primary);">Gerai Sembako</span></h1>
        <p style="color: var(--muted); font-size: 13.5px; margin-top: 4px; display: flex; align-items: center; gap: 6px;">
            ...
            <span class="badge badge-neutral">{{ $products->total() ?? 0 }} Produk</span>
        </p>
    </div>
    <a href="{{ route('staff.products.export') }}" class="btn btn-md btn-secondary btn-pill" data-no-loading>
        📥 Export CSV
    </a>
</div>
