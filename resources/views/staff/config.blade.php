...
<div class="split-layout">
        ...
        <div class="standard-card">
            <form action="{{ route('staff.config.update') }}" method="POST" onsubmit="this.querySelector('button').disabled=true; this.querySelector('button').innerText='Menyimpan...';">
                ...
                <div class="form-group">
                    ...
                    <span style="font-size: 12px; color: var(--colors-muted); margin-top: 4px;">Nama resmi platform yang tampil di judul tab browser dan kop surat/cetakan.</span>
                </div>
                ...
                <div class="form-group" style="margin-top: 18px;">
                    ...
                    <span style="font-size: 12px; color: var(--colors-muted); margin-top: 4px;">Status operasional server saat ini.</span>
                </div>
                ...
                <div class="form-group" style="margin-top: 18px;">
                    ...
                    <span style="font-size: 12px; color: var(--colors-muted); margin-top: 4px;">PENTING: Selalu matikan mode debug (false) di lingkungan produksi untuk keamanan.</span>
                </div>
                ...
                <div class="form-group" style="margin-top: 18px;">
                    ...
                    <span style="font-size: 12px; color: var(--colors-muted); margin-top: 4px;">Lokasi tempat penyimpanan sesi login dan data keranjang belanja warga.</span>
                </div>
                ...
                <div class="form-group" style="margin-top: 18px; margin-bottom: 24px;">
                    ...
                    <span style="font-size: 12px; color: var(--colors-muted); margin-top: 4px;">Batas waktu warga akan otomatis logout jika tidak ada aktivitas di sistem.</span>
                </div>
    ...
    <div class="sticky-rail">
        <div class="reservation-card" style="border-color: var(--colors-warning-border); background: var(--colors-warning-bg);">
            <div>
                <div style="font-size: 32px; margin-bottom: 12px; animation: emoji-bounce 3s ease-in-out infinite;">⚠️</div>
                <h3 style="font-size: 18px; font-weight: 700; margin-bottom: 8px; color: var(--colors-warning);">Informasi Penting</h3>
                <p style="font-size: 13px; color: var(--colors-warning); opacity: 0.9; line-height: 1.6;">
                ...
                <p style="font-size: 13px; color: var(--colors-warning); opacity: 0.9; line-height: 1.6; margin-top: 10px;">
